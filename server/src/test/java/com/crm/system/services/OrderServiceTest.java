...
//    @Mock
//    private LogEntryForOrderFacade logEntryForOrderFacade;
//
//
//    @Test
...
//
//    @Test
//    void sign_agreement_success() throws NoSuchFieldException, IllegalAccessException, UserPrincipalNotFoundException {
//        orderExample.setAgreementSigned(false);
//        orderExample.setIsCalculationShown(InfoIsShown.SHOWN_ONLINE);
...
//
//    @Test
//    void cancel_agreement_success() throws UserPrincipalNotFoundException{
//        orderExample.setAgreementSigned(true);
...
//
//    @Test
//    void confirm_payment_success() throws UserPrincipalNotFoundException {
//        orderExample.setAgreementSigned(true);
//        orderExample.setHasBeenPaid(false);
//
//        when(userService.getActiveUserId()).thenReturn(1L);
//        when(orderRepository.getOrderByOrderIdAndUserId(orderExample.getOrderId(), userService.getActiveUserId()))
//                .thenReturn(Optional.of(orderExample));
//        Mockito.doNothing().when(orderProcessor).confirmPayment(orderExample);
//
//        orderService.confirmPayment(orderExample.getOrderId());
//
//        verify(orderRepository).save(orderExample);
//        verify(logEntryForOrderFacade).automaticallyCreateMessage(any(Order.class), any(EntryType.class),
//                any(MarkAsDoneDecorator.class),any(MarkAsImportantDecorator.class));
//        verify(clientService).saveClient(orderExample.getClient());
//
...
//
//    @Test
//    void cancel_payment_success() throws UserPrincipalNotFoundException {
//        orderExample.setHasBeenPaid(true);
//
//        when(userService.getActiveUserId()).thenReturn(1L);
//        when(orderRepository.getOrderByOrderIdAndUserId(orderExample.getOrderId(), userService.getActiveUserId()))
...
//
//    @Test
//    void create_new_order_success() throws UserPrincipalNotFoundException {
